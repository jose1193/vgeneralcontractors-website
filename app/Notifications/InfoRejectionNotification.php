...
class InfoRejectionNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage->view('emails.info-rejection-notification', [
        ...
        return $mailMessage
            ->subject('Info: Solicitud Rechazada - ' . $this->appointment->first_name . ' ' . $this->appointment->last_name)
