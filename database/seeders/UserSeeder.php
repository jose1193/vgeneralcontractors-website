...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $actions = ['CREATE', 'VIEW', 'UPDATE', 'DELETE', 'RESTORE'];
        ...
        $adminPermissions = [
            'CREATE_APPOINTMENT', 'VIEW_APPOINTMENT', 'UPDATE_APPOINTMENT', 'DELETE_APPOINTMENT', 'RESTORE_APPOINTMENT',
            'CREATE_CALL_RECORD', 'VIEW_CALL_RECORD', 'UPDATE_CALL_RECORD', 'DELETE_CALL_RECORD', 'RESTORE_CALL_RECORD'
        ];
        $adminRole->givePermissionTo($adminPermissions);
        
        // Manager - Invoice Demo and Manager specific permissions
        $managerPermissions = [
            'CREATE_INVOICE_DEMO', 'VIEW_INVOICE_DEMO', 'UPDATE_INVOICE_DEMO', 'DELETE_INVOICE_DEMO', 'RESTORE_INVOICE_DEMO',
            'CREATE_MANAGER', 'VIEW_MANAGER', 'UPDATE_MANAGER', 'DELETE_MANAGER', 'RESTORE_MANAGER'
        ];
        ...
        $salespersonPermissions = [
            'CREATE_SALESPERSON', 'VIEW_SALESPERSON', 'UPDATE_SALESPERSON', 'DELETE_SALESPERSON', 'RESTORE_SALESPERSON'
        ];
        ...
        $marketingManagerPermissions = [
            'CREATE_MARKETING_MANAGER', 'VIEW_MARKETING_MANAGER', 'UPDATE_MARKETING_MANAGER', 'DELETE_MARKETING_MANAGER', 'RESTORE_MARKETING_MANAGER'
        ];
        ...
        $directorAssistantPermissions = [
            'CREATE_DIRECTOR_ASSISTANT', 'VIEW_DIRECTOR_ASSISTANT', 'UPDATE_DIRECTOR_ASSISTANT', 'DELETE_DIRECTOR_ASSISTANT', 'RESTORE_DIRECTOR_ASSISTANT'
        ];
        ...
        $technicalSupervisorPermissions = [
            'CREATE_TECHNICAL_SUPERVISOR', 'VIEW_TECHNICAL_SUPERVISOR', 'UPDATE_TECHNICAL_SUPERVISOR', 'DELETE_TECHNICAL_SUPERVISOR', 'RESTORE_TECHNICAL_SUPERVISOR'
        ];
        $technicalSupervisorRole->givePermissionTo($technicalSupervisorPermissions);
        
        // Continue with other roles...
        $representationCompanyRole->givePermissionTo(['CREATE_REPRESENTATION_COMPANY', 'VIEW_REPRESENTATION_COMPANY', 'UPDATE_REPRESENTATION_COMPANY', 'DELETE_REPRESENTATION_COMPANY', 'RESTORE_REPRESENTATION_COMPANY']);
        $publicCompanyRole->givePermissionTo(['CREATE_PUBLIC_COMPANY', 'VIEW_PUBLIC_COMPANY', 'UPDATE_PUBLIC_COMPANY', 'DELETE_PUBLIC_COMPANY', 'RESTORE_PUBLIC_COMPANY']);
        $externalOperatorsRole->givePermissionTo(['CREATE_EXTERNAL_OPERATORS', 'VIEW_EXTERNAL_OPERATORS', 'UPDATE_EXTERNAL_OPERATORS', 'DELETE_EXTERNAL_OPERATORS', 'RESTORE_EXTERNAL_OPERATORS']);
        $publicAdjusterRole->givePermissionTo(['CREATE_PUBLIC_ADJUSTER', 'VIEW_PUBLIC_ADJUSTER', 'UPDATE_PUBLIC_ADJUSTER', 'DELETE_PUBLIC_ADJUSTER', 'RESTORE_PUBLIC_ADJUSTER']);
        $insuranceAdjusterRole->givePermissionTo(['CREATE_INSURANCE_ADJUSTER', 'VIEW_INSURANCE_ADJUSTER', 'UPDATE_INSURANCE_ADJUSTER', 'DELETE_INSURANCE_ADJUSTER', 'RESTORE_INSURANCE_ADJUSTER']);
        $technicalServicesRole->givePermissionTo(['CREATE_TECHNICAL_SERVICES', 'VIEW_TECHNICAL_SERVICES', 'UPDATE_TECHNICAL_SERVICES', 'DELETE_TECHNICAL_SERVICES', 'RESTORE_TECHNICAL_SERVICES']);
        $marketingRole->givePermissionTo(['CREATE_MARKETING', 'VIEW_MARKETING', 'UPDATE_MARKETING', 'DELETE_MARKETING', 'RESTORE_MARKETING']);
        $warehouseRole->givePermissionTo(['CREATE_WAREHOUSE', 'VIEW_WAREHOUSE', 'UPDATE_WAREHOUSE', 'DELETE_WAREHOUSE', 'RESTORE_WAREHOUSE']);
        $administrativeRole->givePermissionTo(['CREATE_ADMINISTRATIVE', 'VIEW_ADMINISTRATIVE', 'UPDATE_ADMINISTRATIVE', 'DELETE_ADMINISTRATIVE', 'RESTORE_ADMINISTRATIVE']);
        $collectionsRole->givePermissionTo(['CREATE_COLLECTIONS', 'VIEW_COLLECTIONS', 'UPDATE_COLLECTIONS', 'DELETE_COLLECTIONS', 'RESTORE_COLLECTIONS']);
        $reportesRole->givePermissionTo(['CREATE_REPORTES', 'VIEW_REPORTES', 'UPDATE_REPORTES', 'DELETE_REPORTES', 'RESTORE_REPORTES']);
        $leadRole->givePermissionTo(['CREATE_LEAD', 'VIEW_LEAD', 'UPDATE_LEAD', 'DELETE_LEAD', 'RESTORE_LEAD']);
        $employeesRole->givePermissionTo(['CREATE_EMPLOYEES', 'VIEW_EMPLOYEES', 'UPDATE_EMPLOYEES', 'DELETE_EMPLOYEES', 'RESTORE_EMPLOYEES']);
        $clientRole->givePermissionTo(['CREATE_CLIENT', 'VIEW_CLIENT', 'UPDATE_CLIENT', 'DELETE_CLIENT', 'RESTORE_CLIENT']);
        $contactRole->givePermissionTo(['CREATE_CONTACT', 'VIEW_CONTACT', 'UPDATE_CONTACT', 'DELETE_CONTACT', 'RESTORE_CONTACT']);
        $spectatorRole->givePermissionTo(['CREATE_SPECTATOR', 'VIEW_SPECTATOR', 'UPDATE_SPECTATOR', 'DELETE_SPECTATOR', 'RESTORE_SPECTATOR']);
