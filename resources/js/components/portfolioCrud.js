 ...
 * Basado en CrudManager pero independiente
 */
                ...
                html += `
                    <tr class="${rowClass}">
                        ...
                        <td class="px-6 py-4 text-center">
                            ${
                                isDeleted
                                    ? `<button class="restore-btn text-green-600" data-id="${portfolio.uuid}" title="Restore">↻</button>`
                                    : `<button class="edit-btn text-blue-600 mr-2" data-id="${portfolio.uuid}" title="Edit">✏️</button>
                                 <button class="delete-btn text-red-600" data-id="${portfolio.uuid}" title="Delete">🗑️</button>`
                            }
                        </td>
                    </tr>
                `;
