...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'telefono' => [
            ...
            'unique' => 'Este número de teléfono ya está en uso.',
            'max' => 'El número de teléfono no puede tener más de :max caracteres.',
            'regex' => 'El número de teléfono debe tener el formato (XXX) XXX-XXXX.',
        ],
        'email' => [
        ...
        'type' => [
            ...
            'in' => 'El tipo debe ser uno de: Soporte, Ventas, General, Técnico, Facturación, Cobranzas, Admin, Info.',
        ],
        'phone' => [
            'required' => 'El campo teléfono es obligatorio.',
            'unique' => 'Este número de teléfono ya está en uso.',
    ...
    */
    ...
    'attributes' => [
        ...
        'status_lead' => 'estado del prospecto',
        'inspection_date' => 'fecha de inspección',
        'inspection_time' => 'hora de inspección',
        'priority' => 'prioridad',
        'estimated_cost' => 'costo estimado',
        'scheduled_inspection_date' => 'fecha programada de inspección',
        'contact_phone' => 'teléfono de contacto',
        'api_key' => 'clave API',
        'post_title' => 'título del post',
        'post_content' => 'contenido del post',
        'post_image_file' => 'archivo de imagen del post',
        'post_image_url' => 'URL de imagen del post',
        ...
        'blog_category_name' => 'nombre de categoría del blog',
        'blog_category_description' => 'descripción de categoría del blog',
