...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'telefono' => [
            ...
            'regex' => 'Phone number must be in format (XXX) XXX-XXXX.',
        ],
        'email' => [
        ...
        'type' => [
            ...
            'in' => 'The type must be one of: Support, Sales, General, Technical, Billing, Collections, Admin, Info.',
        ],
        'phone' => [
            'required' => 'The phone field is required.',
            'unique' => 'This phone number is already taken.',
    ...
    */
    ...
    'attributes' => [
        ...
        'scheduled_inspection_date' => 'scheduled inspection date',
        'contact_phone' => 'contact phone',
        'api_key' => 'API key',
        'post_title' => 'post title',
        'post_content' => 'post content',
        'post_image_file' => 'post image file',
        ...
        'blog_category_description' => 'blog category description',
