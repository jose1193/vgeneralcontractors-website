...
return [
    ...
    */
    ...
    'custom' => [
        'not_test_data' => 'Test data is not allowed in production. Please use real data.',
        'first_name' => [
        ...
        'phone' => [
            ...
            'max' => 'Please enter a valid 10-digit phone number',
        ],
        'address' => [
        ...
        'insurance_property' => [
            'required' => 'Please select an insurance option',
        ],
        'lead_source' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'zipcode' => 'zip code',
        'country' => 'country',
        'insurance_property' => 'insurance option',
