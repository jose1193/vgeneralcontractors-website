                ...
                <div class="p-6">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <x-crud.toggle-deleted id="showDeleted" label="Mostrar inactivos"
                                manager-name="portfolioManager" />
        ...
        @push('scripts')
            ...
            <script>
                ...
                window.translations = @json([
                    ...
                    'delete_portfolio' => __('delete_portfolio'),
                    'restore_portfolio' => __('restore_portfolio'),
                
                    // Mensajes de confirmación
                    'confirm_delete' => __('confirm_delete_portfolio'),
                    'confirm_restore' => __('confirm_restore_portfolio'),
                    'delete_message' => __('delete_portfolio_message'),
                    'restore_message' => __('restore_portfolio_message'),
                    ...
                    'new_images_to_upload' => __('new_images_to_upload'),
