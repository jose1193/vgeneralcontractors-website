            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-gray-300 mb-4">
                            Your trusted partner for quality roofing services. We provide comprehensive solutions for
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><a href="{{ route('home') }}"
                                    class="text-gray-300 hover:text-white transition">Home</a></li>
                            <li><a href="{{ route('about') }}"
                                    class="text-gray-300 hover:text-white transition">About Us</a></li>
                            <li><a href="{{ route('blog.index') }}"
                                    class="text-gray-300 hover:text-white transition">Blog</a></li>
                            <li><a href="{{ route('contact-support') }}"
                                    class="text-gray-300 hover:text-white transition">Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start">
                                ...
                                <span class="text-gray-300">123 Roofing St, Houston, TX 77001</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-yellow-500 mr-3 mt-1" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span class="text-gray-300">346-692-0757</span>
                            </li>
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-yellow-500 mr-3 mt-1" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                ...
                                <span class="text-gray-300">info@vgeneralcontractors.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-700 mt-10 pt-6 text-center text-gray-400">
                    ...
                    <div class="mt-2 space-x-4">
                        ...
                        <span>|</span>
                        <a href="{{ route('terms-and-conditions') }}" class="hover:text-white">Terms of Service</a>
                    </div>
                </div>
            </div>
        </div>
