    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8">
            <div class="flex justify-between">
                <h2 class="text-2xl font-semibold leading-tight">Edit Appointment</h2>
                ...
                <form id="appointmentEditForm" action="{{ route('appointments.update', $appointment->uuid) }}" method="POST"
                    ...
                    <div class="mt-10 mb-3 flex justify-center">
                        <button type="submit" id="submit-button"
                            ...
                            <span id="submit-button-text">UPDATE APPOINTMENT</span>
                        </button>
                    </div>
                </form>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function setLoadingState(isLoading) {
                ...
                if (isLoading) {
                    ...
                    submitButtonText.textContent = 'Update Appointment';
                }
            }
