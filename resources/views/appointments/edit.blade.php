        ...
        <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
                <div class="flex justify-between">
                    <h2 class="text-2xl font-semibold leading-tight text-white">{{ __('edit_appointment') }}</h2>
                ...
                <div class="my-4 overflow-hidden sm:rounded-md">
                    <form id="appointmentEditForm" action="{{ route('appointments.update', $appointment->uuid) }}"
