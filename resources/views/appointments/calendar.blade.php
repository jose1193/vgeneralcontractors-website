    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6">
                ...
                <div id="eventDetailModal" class="fixed z-50 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title"
                                ...
                                <div class="sm:flex sm:items-start">
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                        <div class="mt-2 space-y-2 text-sm text-gray-600 dark:text-gray-400">
                                            ...
                                            <p><strong>Phone:</strong> <span id="modalEventPhone"></span></p>
                                            ...
                                            <div class="flex flex-col md:flex-row md:gap-6 my-2">
                                                <p><strong>Appointment Status:</strong> <span id="modalEventStatus"
                                                        class="px-2 py-1 text-xs font-bold rounded-full"></span></p>
                                                <p><strong>Lead Status:</strong> <span id="modalEventLeadStatus"
                                                        class="px-2 py-1 text-xs font-bold rounded-full"></span></p>
                                            </div>

                                            <p><strong>Address:</strong> <span id="modalEventAddress"
                                            ...
                                            <input type="hidden" id="event-latitude" name="latitude" value="">
                                            <input type="hidden" id="event-longitude" name="longitude" value="">

                                            <p><strong>Notes:</strong> <span id="modalEventNotes"
                                                    class="whitespace-pre-wrap"></span></p>
                            ...
                            <div
                                ...
                                <div id="statusActionButtons" class="flex space-x-4">
                                    <button type="button" id="confirmAppointmentBtn"
                                        ...
                                        <span class="normal-btn-text">Confirm Appointment</span>
                                    ...
                                    <button type="button" id="declineAppointmentBtn"
                                        ...
                                        <span class="normal-btn-text">Decline Appointment</span>
                                        <span class="processing-btn-text hidden">
                                            <svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-white inline-block"
                                                xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24">
                    ...
                    fetch('{{ route('appointment-calendar.create') }}', {
                        ...
                        .then(data => {
                            ...
                            if (data.success) {
                                ...
                                Swal.fire('Success!', data.message || 'Appointment created successfully',
                                    'success');
                ...
                try {
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            Swal.fire('Moved!', response.message,
                                                'success');
                    ...
                    confirmAppointmentBtn.addEventListener('click', function() {
                        ...
                        Swal.fire({
                            ...
                            text: 'Are you sure you want to confirm this appointment? A confirmation email will be sent to the client.',
                            icon: 'question',
                            showCancelButton: true,
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        Swal.fire('Confirmed!', response.message,
                                            'success');
                    ...
                    declineAppointmentBtn.addEventListener('click', function() {
                        ...
                        Swal.fire({
                            ...
                            text: 'Are you sure you want to decline this appointment? A notification email will be sent to the client.',
                            icon: 'warning',
                            showCancelButton: true,
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        Swal.fire('Declined!', response.message,
                                            'success');
                                        calendar.refetchEvents(); // Refresh calendar events
                                        eventDetailModal.classList.add(
                                            'hidden'); // Close modal
