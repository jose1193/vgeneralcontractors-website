        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0 sm:ml-4">
                    <button
                        type="button"
                        onclick="window.calendarMain?.createNewAppointment()"
...
<meta name="calendar-status-url" content="{{ url()->secure(route('appointment-calendar.updateStatus', ':id', [], false)) }}">
<meta name="calendar-clients-url" content="{{ url()->secure(route('appointment-calendar.getClients', [], false)) }}">