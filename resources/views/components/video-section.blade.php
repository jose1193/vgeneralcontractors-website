...
<section class="py-16 bg-gray-900 fade-in-section" x-data="{ showAppointmentModal: false }">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <h2 class="text-4xl font-bold mt-2 mb-4 text-white">{{ __('see_how_we_transform') }}</h2>
            <p class="text-gray-300 max-w-3xl mx-auto">{{ __('experience_commitment_quality') }}</p>
        </div>
        ...
        <div class="text-center mt-12">
            <p class="text-gray-300 text-lg mb-6">{{ __('ready_transform_roof') }}</p>
            <div class="flex justify-center gap-4">
                ...
                <a href="tel:{{ $companyData->phone }}"
                    ...
                    {{ __('call_phone_number', ['phone' => PhoneHelper::format($companyData->phone)]) }}
                </a>
            </div>
        </div>
    </div>
