...
<section class="py-16 bg-gray-900 fade-in-section" x-data="{ showAppointmentModal: false }">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-300 max-w-3xl mx-auto">{{ __('experience_our_commitment') }}</p>
        </div>
        ...
        <div class="text-center mt-12">
            <p class="text-gray-300 text-lg mb-6">{{ __('ready_to_transform') }}</p>
            <div class="flex justify-center gap-4">
                ...
                <a href="tel:{{ $companyData->phone }}"
                    ...
                    {{ __('call_now') }} {{ PhoneHelper::format($companyData->phone) }}
                </a>
            </div>
        </div>
    </div>
