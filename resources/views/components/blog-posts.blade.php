    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="mb-10 md:mb-16">
            <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">
                {{ __('latest_from_blog') }}</h2>
            <p class="mx-auto max-w-screen-md text-center text-gray-600 md:text-lg">{{ __('stay_updated_blog') }}</p>
        </div>
        <!-- text - end -->
        ...
        <div class="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-4">
            ...
            @empty
                ...
                <div class="col-span-full text-center py-8">
                    <p class="text-lg text-gray-600">{{ __('check_back_soon') }}</p>
                </div>
            @endforelse
        </div>
