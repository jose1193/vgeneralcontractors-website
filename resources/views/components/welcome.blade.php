<div style="background-color: #141414;" class="text-white min-h-screen">
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Recent Activity -->
            <div class="lg:col-span-2" style="background-color: #2C2E36;" class="rounded-lg border border-gray-900">
            ...
            <!-- Quick Actions -->
            <div style="background-color: #2C2E36;" class="rounded-lg border border-gray-900">
                <div class="px-6 py-4 border-b border-gray-900">
                    <h3 class="text-lg font-semibold text-white">Quick Actions</h3>
                </div>
                <div class="p-6 space-y-4">
                    <button
                        class="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-medium py-3 px-4 rounded-lg transition-colors">
                        Schedule Appointment
                    </button>
                    <button
                        class="w-full border border-gray-900 hover:bg-gray-800 text-white font-medium py-3 px-4 rounded-lg transition-colors">
                        Add New Project
                    </button>
                    <button
                        class="w-full border border-gray-900 hover:bg-gray-800 text-white font-medium py-3 px-4 rounded-lg transition-colors">
