                ...
                <div class="relative w-full lg:w-1/3 mb-3 lg:mb-0">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="2" viewBox="0 0 24 24" class="w-6 h-6 text-gray-400">
                            <path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                        </svg>
                    </span>
                    <input type="text" id="{{ $searchId }}" placeholder="{{ $searchPlaceholder }}"
                ...
                @if ($showExport)
                    ...
                    <div class="relative flex items-center justify-end sm:justify-start w-full sm:w-auto group">
                        <select id="{{ $exportId }}"
                            ...
                            <option value="" disabled selected class="bg-gray-900/95 text-white">
                                {{ $exportLabel }}</option>
                            <option value="pdf" class="bg-gray-900/95 text-white hover:bg-purple-600/20">📄 PDF
                                Report</option>
                            <option value="excel" class="bg-gray-900/95 text-white hover:bg-purple-600/20">📊 Excel
                            </option>
                        </select>
                        <!-- Export Icon -->
