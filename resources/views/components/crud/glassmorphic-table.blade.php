...
<div class="relative overflow-hidden rounded-[6px]">
    ...
    <div class="absolute inset-0 rounded-[6px] p-[2px] animate-border-glow">
        <div
            class="absolute inset-0 rounded-[6px] bg-gradient-to-r from-blue-400 via-purple-500 via-gray-500 to-blue-400 bg-[length:300%_300%] animate-gradient-border opacity-70">
        </div>
