...
<div class="relative overflow-hidden rounded-[6px]">
    ...
    <div class="absolute inset-0 rounded-[6px] p-[2px] animate-border-glow">
        ...
        <div class="relative w-full h-full bg-black/80 backdrop-blur-[10px] rounded-[4px] border border-white/5"></div>
    </div>

    {{-- Table container with enhanced animated shadows --}}
    <div class="relative bg-black/40 backdrop-blur-[10px] border-0 rounded-[4px] overflow-hidden m-[2px] animate-table-shadow shadow-lg shadow-purple-500/30">
