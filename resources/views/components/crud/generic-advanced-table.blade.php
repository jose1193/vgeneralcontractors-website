...
<style>
    .glassmorphism-container {
        ...
        box-shadow:
            ...
            0 16px 64px rgba(128, 0, 255, 0.18),
    ...
    .glassmorphism-container:hover {
        ...
        box-shadow:
            0 12px 48px rgba(138, 43, 226, 0.35),
            0 24px 80px rgba(128, 0, 255, 0.25),
            0 6px 24px rgba(75, 0, 130, 0.4),
    ...
    .glassmorphism-table-wrapper {
        ...
        border-radius: 16px;
        box-shadow:
            0 6px 24px rgba(138, 43, 226, 0.22),
            0 12px 48px rgba(128, 0, 255, 0.15),
            0 2px 12px rgba(75, 0, 130, 0.25),
            0 1px 6px rgba(147, 51, 234, 0.18),
    ...
    .glassmorphism-header {
        ...
        box-shadow:
            0 2px 16px rgba(138, 43, 226, 0.15),
            0 4px 24px rgba(128, 0, 255, 0.1),
            0 1px 6px rgba(75, 0, 130, 0.2),
            inset 0 1px 0 rgba(255, 255, 255, 0.1);
