...
<div>
    ...
    <input type="text" x-model="form.name"
        ...
        :class="{ 'border-red-500': errors.name }" placeholder="{{ __('enter_ceo_name') }}">
...
<div>
    ...
    <input type="tel" x-model="form.phone"
        ...
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        :class="{ 'border-red-500': errors.phone }" placeholder="{{ __('enter_phone') }}">
...
<div>
    ...
    <input type="url" x-model="form.website"
        ...
        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        :class="{ 'border-red-500': errors.website }" placeholder="{{ __('enter_website') }}">
    <div class="text-red-500 text-xs mt-1" x-show="errors.website" x-text="errors.website"></div>
    <span class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('website_help_text') }}</span>
</div>
