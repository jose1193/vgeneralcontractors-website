    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div class="text-center md:text-left">
                ...
                <div class="space-y-3">
                    <p class="flex items-start justify-center md:justify-start">
                        <svg class="w-5 h-5 mr-2 mt-1 text-yellow-500 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span class="text-sm sm:text-base md:text-lg">1302 Waugh Dr # 810<br>Houston TX 77019</span>
                    </p>
                    <p class="flex items-center justify-center md:justify-start">
                        ...
                        <span class="text-sm sm:text-base md:text-lg">+1 (346) 692-0757</span>
                    </p>
                    <p class="flex items-center justify-center md:justify-start">
                        <svg class="w-5 h-5 mr-2 text-yellow-500 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                        ...
                        <span class="text-sm sm:text-base md:text-lg">info@vgeneralcontractors.com</span>
                    </p>
                    <a href="#"
                        class="inline-flex items-center justify-center md:justify-start text-yellow-500 hover:text-yellow-400 transition-colors text-sm sm:text-base md:text-lg">
            ...
            <div class="text-center md:text-left">
                ...
                <ul class="space-y-2">
                    <li><a href="#"
                            class="hover:text-yellow-500 transition-colors text-sm sm:text-base md:text-lg">About Us</a>
                    </li>
                    <li><a href="#"
                            class="hover:text-yellow-500 transition-colors text-sm sm:text-base md:text-lg">Portfolio</a>
                    </li>
                    <li><a href="#"
                            class="hover:text-yellow-500 transition-colors text-sm sm:text-base md:text-lg">New Roof</a>
                    </li>
                    <li><a href="#"
                    ...
                    <li><a href="#"
                            ...
                            Damage</a></li>
                    <li><a href="#"
                            class="hover:text-yellow-500 transition-colors text-sm sm:text-base md:text-lg">Complaints
            ...
            <div class="text-center md:text-left">
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#"
                            ...
                            Support</a></li>
                    <li><a href="#"
                            class="hover:text-yellow-500 transition-colors text-sm sm:text-base md:text-lg">Financing
                            Options</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-800 pt-8 mt-4 text-center">
            <p class="text-sm sm:text-base md:text-lg text-gray-400">Copyright © {{ date('Y') }}
                www.vgeneralcontractors.com - All Rights
                Reserved</p>
        </div>
    </div>
</footer>
