    ...
    <div style="background-color: #141414;" class="text-white min-h-screen">
        ...
        <div class="p-6">
            <div class="mb-8 text-center sm:text-center md:text-left lg:text-left">
                ...
                <p class="text-xs sm:text-xs md:text-base lg:text-base text-gray-400">{{ __('call_records_subtitle') }}
                </p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg">
                    <div class="p-6">
                        ...
                        <div
                            ...
                            <div
                                class="flex flex-col lg:flex-row items-center w-full md:w-auto space-y-4 lg:space-y-0 lg:space-x-6">
                                <!-- Date Range Controls -->
                                <div
                                    class="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-2 w-full lg:w-auto">
                                    <button id="date-range-btn"
                                        class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    ...
                                    <button id="clear-date-range"
                                        class="hidden w-full sm:w-auto inline-flex items-center justify-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                                ...
                                <!-- Per Page Dropdown -->
                                <div class="relative w-full sm:w-40 lg:w-32">
                                    <select id="per-page"
