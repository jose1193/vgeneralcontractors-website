                ...
                <div class="p-6">
                    ...
                    <div
                        ...
                        <div class="w-full md:w-1/2 lg:w-2/5">
                            <x-crud.input-search id="searchInput" placeholder="{{ __('search_blog_categories') }}"
                                manager-name="blogCategoryManager" />
                        </div>

                        <div
                            class="flex flex-col sm:flex-row items-center w-full md:w-auto space-y-3 sm:space-y-0 sm:space-x-4">
                            <!-- Toggle to show inactive blog categories -->
                            ...
                            <div class="w-full sm:w-auto">
                                <button id="createBlogCategoryBtn"
