            ...
            <div class="prose prose-lg max-w-none">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ route('contact-support') }}" target="_blank" rel="noopener noreferrer"
                        class="inline-flex items-center justify-center space-x-2 bg-yellow-500 text-white text-decoration-none font-semibold px-8 py-3 text-lg rounded hover:bg-yellow-600 transition-colors duration-300">
