<x-crud.index-layout 
    ...
    subtitle="{{ __('users_subtitle') }}"
    entity-name="User"
    entity-name-plural="Users"
    search-placeholder="{{ __('search_users') }}"
    show-deleted-label="{{ __('show_inactive_users') }}"
    add-new-label="{{ __('add_user') }}"
    manager-name="userManager"
    table-id="userTable"
    create-button-id="createUserBtn"
