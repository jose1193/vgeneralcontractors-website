...
<head>
    ...
    <title>Su cita ha sido reagendada</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>Le informamos que su cita con <strong>{{ $companyData->company_name }}</strong> ha sido reagendada
            exitosamente.</p>
        ...
        <p>Si necesita hacer algún cambio en su cita, por favor contáctenos lo antes posible.</p>
