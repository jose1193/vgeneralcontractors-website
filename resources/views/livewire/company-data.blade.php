            ...
            <div class="p-6">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                            @forelse ($companies as $index => $company)
                                <tr class="{{ $company->trashed() ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">{{ $company->email }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                        <div class="inline-flex items-center justify-center space-x-4">
                                            ...
                                            @if ($company->trashed())
                                                <!-- Restore button -->
                                                <button
                                                    @click="window.dispatchEvent(new CustomEvent('restore-confirmation', {detail: {id: {{ $company->id }}, company_name: '{{ addslashes($company->company_name) }}'}}))"
                                            ...
                                            @else
                                                <!-- Delete button -->
                                                <button
                                                    @click="window.dispatchEvent(new CustomEvent('delete-confirmation', {detail: {id: {{ $company->id }}, company_name: '{{ addslashes($company->company_name) }}'}}))"
                ...
                <div class="mt-4 flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                    <div class="text-sm text-gray-700 dark:text-gray-300 w-full sm:w-auto text-center sm:text-left">
                        Showing {{ $companies->firstItem() ?? 0 }} to {{ $companies->lastItem() ?? 0 }} of
                        ...
                        <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <div class="text-red-500 text-xs mt-1" x-show="errors.company_name"
                                ...
                                <div class="mb-4">
                                    <label for="name"
                                        class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">CEO
                                        Name:</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="text-red-500 text-xs mt-1" x-show="errors.address"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="text-red-500 text-xs mt-1" x-show="errors.website"
                                        x-text="errors.website"></div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400" x-show="companyToDelete">
                                    Are you sure you want to delete the company <span class="font-bold"
                                        x-text="companyToDelete?.company_name"></span>? This action will soft delete
                                    the company.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400" x-show="companyToRestore">
                                    Are you sure you want to restore the company <span class="font-bold"
                                        x-text="companyToRestore?.company_name"></span>? This action will reactivate
                                    the company.
                                </p>
                            </div>
                        </div>
