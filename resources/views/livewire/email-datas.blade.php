<div>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap text-sm font-medium text-center">
                                        <div class="inline-flex items-center justify-center space-x-2">
                                            ...
                                            @if ($emailData->deleted_at)
                                                <button
                                                    @click="$dispatch('open-restore-modal', '{{ $emailData->uuid }}')"
                                            ...
                                            @else
                                                <button
                                                    @click="$dispatch('open-delete-modal', { uuid: '{{ $emailData->uuid }}', email: '{{ $emailData->email }}' })"
    ...
    <div x-data="{
        ...
        emailText = $event.detail.email;
        isDeleting = false;
    "
        @emailDeleted.window="showDeleteModal = false" x-show="showDeleteModal" x-cloak
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    Are you sure you want to delete the email <span
                                        class="font-bold text-gray-700 dark:text-gray-300" x-text="emailText"></span>?
    ...
    <div x-data="{ showRestoreModal: false, emailToRestore: null }" @open-restore-modal.window="showRestoreModal = true; emailToRestore = $event.detail"
        @email-restored.window="showRestoreModal = false" x-show="showRestoreModal" x-cloak
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 dark:bg-gray-900 bg-opacity-75 transition-opacity"
                aria-hidden="true" x-show="showRestoreModal" x-transition:enter="ease-out duration-300"
            ...
            <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                x-show="showRestoreModal" x-transition:enter="ease-out duration-300"
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button type="button" @click="$wire.restore(emailToRestore.uuid)"
