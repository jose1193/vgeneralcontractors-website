                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-600">
                            @forelse ($emailDatas as $index => $emailData)
                                <tr class="{{ $emailData->trashed() ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">{{ $emailData->email }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                        <div class="inline-flex items-center justify-center space-x-4">
                                            ...
                                            @if ($emailData->trashed())
                                                <!-- Restore button -->
                                                <button
                                                    @click="window.dispatchEvent(new CustomEvent('restore-confirmation', {detail: {uuid: '{{ $emailData->uuid }}', email: '{{ addslashes($emailData->email) }}'}}))"
                                            ...
                                            @else
                                                <!-- Delete button -->
                                                <button
                                                    @click="window.dispatchEvent(new CustomEvent('delete-confirmation', {detail: {uuid: '{{ $emailData->uuid }}', email: '{{ addslashes($emailData->email) }}'}}))"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select x-model="form.type"
                                        @change="$wire.set('type', $event.target.value); validateField('type');"
                                        id="type"
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 dark:bg-gray-700 leading-tight focus:outline-none focus:placeholder-gray-400 dark:focus:placeholder-gray-500 focus:border-blue-300 dark:focus:border-blue-600 focus:ring focus:ring-blue-200 dark:focus:ring-blue-700 focus:ring-opacity-50 sm:text-sm"
                                    ...
                                    <div class="text-red-500 text-xs mt-1" x-show="errors.type" x-text="errors.type">
                                    </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400" x-show="emailToDelete">
                                    Are you sure you want to delete the email <span class="font-bold"
                                        x-text="emailToDelete?.email"></span>? This action will soft delete the email.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400" x-show="emailToRestore">
                                    Are you sure you want to restore the email <span class="font-bold"
                                        x-text="emailToRestore?.email"></span>? This action will reactivate the email.
                                </p>
                            </div>
                        </div>
                    </div>
