<div>
                        ...
                        @forelse($emailDatas as $emailData)
                            <tr>
                                ...
                                <td
                                    class="px-6 py-4 whitespace-no-wrap text-sm text-gray-500 dark:text-gray-400 text-center">
                                    <a
                                        href="tel:{{ $emailData->phone }}">{{ \App\Helpers\PhoneHelper::format($emailData->phone) }}</a>
                                </td>
                                <td
                                    class="px-6 py-4 whitespace-no-wrap text-sm text-gray-500 dark:text-gray-400 text-center">
                                    <span
    ...
    <div class="fixed inset-0 z-50 overflow-y-auto" style="display: none" x-data="{ show: false, email: null }" x-show="show"
        x-on:delete-confirmation.window="show = true; email = $event.detail">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900"
                                x-text="'Delete Email: ' + (email ? email.description : '')"></h3>
                            <div class="mt-2">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button @click="$wire.delete(email.uuid); show = false;" type="button"
